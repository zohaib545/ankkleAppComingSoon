...
if($_POST) {
    ...
    $to_Email = "info@ankkleapp.com"; // Write your email here
    ...
    if(!$Mailsending) {
        ...
        $output = json_encode(array('type'=>'message', 'text' => '<i class="icon ion-checkmark-round"></i> Hello '.$_POST["userName"] .', Thanks! We got your message and will get back ASAP !'));
        die($output);
    }
}
?>